...
import { BoldStatementCard } from "../archetypes/bold-statement/bold-statement-card";
...
export function BoldStatementPreview({
  publication,
  persistFinalRender,
}: {
  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold">Bold Statement · v1</p>
          <p className="mt-1 text-xs text-[var(--muted)]">
            Composición editorial para una idea principal con muy pocos elementos.
          </p>
        </div>
      ...
      >
        ...
        >
          <div ref={exportNodeRef} style={{ width: CANVAS_WIDTH, height: CANVAS_HEIGHT }}>
            <BoldStatementCard publication={publication} />
          </div>
        </div>
      </div>
    </div>
