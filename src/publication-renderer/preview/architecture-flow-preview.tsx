...
import { ArchitectureFlowCard } from "../archetypes/architecture-flow/architecture-flow-card";
  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold">Architecture Flow · v1</p>
          <p className="mt-1 text-xs text-[var(--muted)]">
            Flujo técnico en capas: problema, decisión y resultado.
          </p>
        </div>
      ...
      >
        ...
        >
          <div ref={exportNodeRef} style={{ width: CANVAS_WIDTH, height: CANVAS_HEIGHT }}>
            <ArchitectureFlowCard publication={publication} />
          </div>
        </div>
      </div>
    </div>
