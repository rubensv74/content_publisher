...
import { HeroScreenshotCard } from "../archetypes/hero-screenshot/hero-screenshot-card";
...
export function HeroScreenshotPreview({
  publication,
  persistFinalRender,
}: {
  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold">Hero Screenshot · v1</p>
          <p className="mt-1 text-xs text-[var(--muted)]">
            El screenshot privado se integra en el render final; Buffer recibe únicamente el PNG final.
          </p>
        </div>
      ...
      >
        ...
        >
          <div ref={exportNodeRef} style={{ width: CANVAS_WIDTH, height: CANVAS_HEIGHT }}>
            <HeroScreenshotCard publication={publication} />
          </div>
        </div>
      </div>
    </div>
