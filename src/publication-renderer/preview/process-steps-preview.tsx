...
import { ProcessStepsCard } from "../archetypes/process-steps/process-steps-card";
  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div>
          <p className="text-sm font-semibold">Process Steps · v1</p>
          <p className="mt-1 text-xs text-[var(--muted)]">
            Convierte la historia en una secuencia técnica legible de decisiones y resultado.
          </p>
        </div>
      ...
      >
        ...
        >
          <div ref={exportNodeRef} style={{ width: CANVAS_WIDTH, height: CANVAS_HEIGHT }}>
            <ProcessStepsCard publication={publication} />
          </div>
        </div>
      </div>
    </div>
